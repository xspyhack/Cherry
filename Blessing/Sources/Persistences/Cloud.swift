...
public final class Cloud {
    /// iCloud directory
    public enum UbiquitousScope: Equatable {
        case documents
        case data
    }
    ...
    public static let shared = Cloud()
    ...
    public func url(atPath path: String, in scope: UbiquitousScope) throws -> URL {
    ...
    @discardableResult
    public func contents(atPath path: String, in scope: UbiquitousScope, completionHandler: @escaping ([URL]) -> Void) throws -> Bool {
    ...
    public func copyItem(at localURL: URL) throws {
        // make a copy first
    ...
    public func removeItem(at localURL: URL) throws {
    ...
    /// - Parameter localURL: The URL of the item (file or directory) that you want to store in iCloud.
    public func moveItem(from localURL: URL) throws {
        let ubiquityURL = try url(atPath: localURL.lastPathComponent, in: .documents)
    ...
    public func moveItem(to localURL: URL) throws {
        let ubiquityURL = try url(atPath: localURL.lastPathComponent, in: .documents)
    ...
    public func setUbiquitous(_ flag: Bool, itemAt sourceURL: URL, to destinationURL: URL) throws {
